...
describe TPX_2_2::Collection do
  subject {
    TPX_2_2::Collection.new( [collection_element_1] )
  }
  let(:collection_2) {
    TPX_2_2::Collection.new( [collection_element_1, collection_element_2] )
  }
  let(:collection_element_1) {
    TPX_2_2::CollectionElement.new( collection_hash_1 )
  }
  let(:collection_element_2) {
    TPX_2_2::CollectionElement.new( collection_hash_2 )
  }
  ...
  describe '#initialize' do
    ...
    it 'should only allow CollectionElement objects' do
      expect{
        TPX_2_2::Collection.new([1])
      }.to raise_error(
        TPX_2_2::ValidationError, 'Supplied input object 1 at position 0 not of required type TPX_2_2::CollectionElement in TPX_2_2::Collection!'
      )
    end
  end
