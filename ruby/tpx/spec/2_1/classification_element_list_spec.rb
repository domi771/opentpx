...
describe TPX_2_1::ClassificationElementList do
  subject { TPX_2_1::ClassificationElementList.new(classification_elements) }
  ...
  let(:classification_element_2) {
    TPX_2_1::ClassificationElement.new(classification_element_hash_2)
  }
  let(:classification_element_3) {
    TPX_2_1::ClassificationElement.new(classification_element_hash_3)
  }
